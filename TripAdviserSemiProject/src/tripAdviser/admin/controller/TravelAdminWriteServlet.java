...
/**
 * Servlet implementation class TravelAdminWriteServlet
 */
@WebServlet("/travel/travelAdminWrite")
public class TravelAdminWriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TravelAdminWriteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*String file=request.getParameter("trvPicSrc1");
		String trvCtg=request.getParameter("trvCtg");
		String trvProvince=request.getParameter("trvProvince");*/

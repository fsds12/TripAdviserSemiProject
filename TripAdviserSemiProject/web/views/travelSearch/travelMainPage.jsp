...
div.card div img{width:100%; height:300px;}
</style>
...
<div class="box-padding-big light-bg">
	<div class="container">
		...
		<div class="card-group">
			<div class="card">
				<div style="background: #eee; height: 300px;"><a href="<%=request.getContextPath()%>/travel/travelProductDetail?trvNo=<%=tp1.getTrvNo()%>"><img src="<%=tp1.getTrvRepresentPic()%>" /></a></div>
			...
			<div class="card">
				<div style="background: #eee; height: 300px;"><a href="<%=request.getContextPath()%>/travel/travelProductDetail?trvNo=<%=tp2.getTrvNo()%>"><img src="<%=tp2.getTrvRepresentPic()%>" /></a></div>
				<div class="card-block">
			...
			<div class="card">
				<div style="background: #eee; height: 300px;"><a href="<%=request.getContextPath()%>/travel/travelProductDetail?trvNo=<%=tp3.getTrvNo()%>"><img src="<%=tp3.getTrvRepresentPic()%>" /></a></div>
				<div class="card-block">

...
tplist=new travelSearchService().travelSearchCt(7);
...
<div class="box-padding-big light-bg">
	<div class="container">
		<h4 class="category-title">전체 볼거리 최고 별점 Best sightseeing in our website</h4>
		<p class="category-sub">별점순 최고 볼거리 랭킹 Top ranking The most popular sightseeing spots selected by our guests.</p>

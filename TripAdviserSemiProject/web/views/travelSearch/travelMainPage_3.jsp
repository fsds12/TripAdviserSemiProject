...
tplist=new travelSearchService().travelSearchCt(6);
...
<div class="box-padding-big light-bg">
	<div class="container">
		<h4 class="category-title">전체 템플스테이 최고 별점 Best temple stay in our website</h4>
		<p class="category-sub">별점순 최고 템플스테이 랭킹 Top ranking The most popular temple stays
